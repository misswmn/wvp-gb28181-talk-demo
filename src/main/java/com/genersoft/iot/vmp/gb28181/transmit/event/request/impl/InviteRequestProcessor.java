    ...
    public void broadcastInviteOk(SIPRequest request, String deviceId, String addressStr, int port) {
        ...
        try {
            ...
            if (isUdp == 1) {
                ...
                startSendRtpResponse = zlmrtpServerFactory.startSendRtpStream(mediaServerItem, params);
            } else {
                //startSendRtpResponse = zlmrtpServerFactory.startSendRtpPassive(mediaServerItem, params);
            }
